...
const allNetworks: Record<NetworkId, NetworkConfig> = {
  mainnet: {
    ...
    wsUrl: process.env.NEXT_PUBLIC_MAINNET_WS_URL || toWsUrl(process.env.NEXT_PUBLIC_MAINNET_RPC_URL || "http://localhost:9944"),
  ...
  testnet: {
    ...
    wsUrl: process.env.NEXT_PUBLIC_TESTNET_WS_URL || toWsUrl(process.env.NEXT_PUBLIC_TESTNET_RPC_URL || "http://localhost:19944"),
  ...
  devnet: {
    ...
    wsUrl: process.env.NEXT_PUBLIC_DEVNET_WS_URL || toWsUrl(process.env.NEXT_PUBLIC_DEVNET_RPC_URL || "http://localhost:29944"),
