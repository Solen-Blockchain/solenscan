...
export default function TransactionsPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 py-8">
      <h1 className="mb-6 text-2xl font-bold text-gray-900 dark:text-gray-100">Transactions</h1>
      ...
      <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-slate-900 shadow-sm">
        <div className="p-6">
          {loading && txs.length === 0 ? (
            ...
            <p className="py-8 text-center text-gray-400 dark:text-gray-500">No transactions found</p>
          )}
        </div>
